## pf accessibility raw set-text-contents

Invoke EditableText SetTextContents

```
pf accessibility raw set-text-contents [flags]
```
...
```
  ...
  -h, --help              help for set-text-contents
