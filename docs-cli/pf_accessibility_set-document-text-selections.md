## pf accessibility set-document-text-selections

Set cross-object selections through AT-SPI Document 2.52

```
pf accessibility set-document-text-selections [flags]
```
...
```
  ...
  -h, --help                  help for set-document-text-selections
      ...
      --selections string     JSON array of DocumentTextSelection values (character offsets) (default "[]")
