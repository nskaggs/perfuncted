## pf accessibility raw remove-text-selection

Invoke Text RemoveSelection

```
pf accessibility raw remove-text-selection [flags]
```
...
```
  ...
  -h, --help              help for remove-text-selection
