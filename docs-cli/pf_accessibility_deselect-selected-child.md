## pf accessibility deselect-selected-child

Deselect the selected child through AT-SPI Selection

```
pf accessibility deselect-selected-child [flags]
```
...
```
  ...
  -h, --help                  help for deselect-selected-child
